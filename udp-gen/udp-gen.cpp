...
// udp-gen.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CudpgenApp, CWinApp)
...
// Единственный объект CudpgenApp

CudpgenApp theApp;


// инициализация CudpgenApp

BOOL CudpgenApp::InitInstance()
{
